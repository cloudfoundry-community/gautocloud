// Package interceptor This permit to intercept data which will be given back by gautocloud and modified it before giving back to user.
...
// IntercepterFunc The IntercepterFunc type is an adapter to allow the use of

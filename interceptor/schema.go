...
// SchemaIntercepter User must implement this interface on his struct/schema to be able to intercept injected value from gautocloud.
// User could now modify his own schema, gautocloud will use user schema as injection.
...
// NewSchema Interceptor to let user implements himself write an interception on his struct/schema.
